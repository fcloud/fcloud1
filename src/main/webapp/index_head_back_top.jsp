		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul id="navs" class="nav navbar-nav">
					<li><a href="/index/thePublicManage">公众号管理</a></li>
					<li class="active"><a href="/index/backgroundManage">后台管理</a></li>
			    ...
			    <div class="navbar-form navbar-right">
					...
					<div id="div_public" class="btn-group">
						<button type="button" id="wepublicno" class="btn btn-info btn-sm">测试公众号1</button>
						<button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown">
					    <span class="caret"></span>
					    <span class="sr-only">菜单</span>
						</button>
